...
@RestController
@RequestMapping("/api/test-application-kafka")
public class TestApplicationKafkaResource {

    private final Logger log = LoggerFactory.getLogger(TestApplicationKafkaResource.class);
    ...
    public TestApplicationKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
